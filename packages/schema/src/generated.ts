...
import { StringKeys } from "./helpers";
import {
  AllNodes,
  BaseNode,
  NodeMap,
...
export interface StatelyConfig<
  Components extends
    OpenAPIV3_1.ComponentsObject = OpenAPIV3_1.ComponentsObject,
  Paths extends OpenAPIV3_1.PathsObject<any, any> = OpenAPIV3_1.PathsObject<
    any,
    any
  >,
...
export type GeneratedNodeMap<Config extends StatelyConfig> = [
  StringKeys<Config["nodes"]>,
] extends [never]
  ? NodeMap
  : {
...
export type GeneratedNodes<Config extends StatelyConfig> = AllNodes<
  GeneratedNodeMap<Config>
>;
export type GeneratedNodeUnion<Config extends StatelyConfig> = NodeUnion<
  GeneratedNodeMap<Config>
>;
