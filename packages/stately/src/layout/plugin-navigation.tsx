...
import type { RouteOption } from '@statelyjs/ui/runtime';
import { ChevronRight } from 'lucide-react';
import { useState } from 'react';
import type { NavigationRoutes } from './navigation';
import { log } from '@/utils';
import { stripTrailing, toTitleCase } from '@statelyjs/ui/utils';
...
export function PluginNavigation({
  ...
  log.debug('Base', `rendering plugin items for ${sidebarTo}:`, { basePath, currentPath, sidebar });
