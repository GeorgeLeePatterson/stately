  ...
  return (
    ...
    >
      ...
      <CollapsibleTrigger asChild>
        <Item
          className="connector-summary-filter cursor-pointer py-1"
      ...
      {/* Details */}
      <CollapsibleContent className="h-full flex-auto space-y-3 py-2 px-3 border-muted border rounded-md">
        <FieldSet
