...
import { Item, ItemActions, ItemContent, ItemGroup, ItemTitle } from '@/core/components/ui/item';
...
export type MapViewProps<Schema extends CoreSchemas = CoreSchemas> = ViewFieldProps<
  Schema,
  CoreMapNode<Schema>,
  AnyRecord
>;
