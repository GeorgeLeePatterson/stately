...
export type NavigationProps = NavigationBaseProps & React.ComponentProps<typeof Sidebar>;

export function Navigation<S extends StatelySchemas<any, any> = StatelySchemas<any, any>>({
  logo,
  logoName,
  ...rest
}: NavigationProps) {
