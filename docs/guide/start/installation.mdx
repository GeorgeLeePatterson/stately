...
> [!DETAILS]
> For out-of-the-box use cases, stately exports the most commonly used components, such as `Layout`, `BaseForm`, etc. If you want access to the base components or other items not re-exported by stately, you can install `@statelyjs/ui` directly and import them yourself.
...
<PackageManagerTabs command="install @uiw/react-codemirror @uiw/codemirror-extensions-langs" />
